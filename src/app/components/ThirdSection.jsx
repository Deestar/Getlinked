  ...
  return (
    <section className="pt-10 relative flex flex-col gap-y-14 row:flex-row row:justify-around row:items-center pb-7 overflow-hidden ">
      <motion.div
        ...
        whileInView="animate"
        viewport={{ once: true }}
        className="flex justify-center relative  row:order-2 "
      >
        <Image
          src={Lego}
      ...
      <article className="flex flex-col items-center px-1 se:px-2 relative  row:order-1 ">
        ...
        <motion.h2
          ...
          viewport={{ once: true }}
          custom={1}
          className="font-clash text-lg se:text-xl text-center flex flex-col sm:text-2xl md:text-3xl row:text-start row:text-3xl lg:text-3xl/[1.4] z-[2]"
        >
          Rules and
        ...
        <motion.p
          ...
          whileInView="animate"
          custom={2}
          className="text-center max-w-xs font-montsm text-xs/loose se:text-sm/loose sm:text-base desk:max-w-sm row:text-start row:text-sm z-[2]"
        >
