        ...
        <article className="relative flex flex-col items-center gap-y-2 w-max  row:items-start pl-8 ">
          <header className="text-[1.7rem]/tight font-clash se:text-3xl se_lg:text-4xl desk:text-5xl lg:text-6xl xl:text-7xl">
            ...
            <motion.h1
              ...
              viewport={{ once: true }}
              custom={1}
              className="text-end pr-6 relative z-20 text-white row:text-start"
            >
              getlinkedTech
              <Image
            ...
            <motion.h1
              ...
              viewport={{ once: true }}
              custom={2}
              className="flex gap-1 text-white z-30"
            >
          ...
          <motion.p
            ...
            viewport={{ once: true }}
            custom={3}
            className="z-20  text-white max-w-[16rem] w-[12rem] se:w-auto  se:px-1 font-montsm text-[0.68rem]/loose text-center flex items-center se:text-sm/relaxed  row:items-start row:text-start row:max-w-[21.5rem]"
          >
