  ...
  return (
    <section className="bg-[#150E28] flex flex-col py-12 gap-y-10 justify-center items-center ">
      ...
      <section className=" p-1 h-max w-full flex justify-center ">
        <div className="grid grid-cols-[auto_auto_auto] grid-rows-[auto_auto_auto] gap-y-3 gap-x-5 border border-getlink py-12 px-1 se:px-10 desk:px-16 sm:px-20 lg:px-28">
          <div className=" relative">
            <span className="absolute  border-2 h-0 border-getlink -bottom-2 w-full "></span>
            <span className="absolute  border-2 w-0 border-getlink -right-3 h-full "></span>
            <Image
              src={Assured}
              className=" w-14 h-14 se:w-20 se:h-20 se_lg:w-24 se_lg:h-24 desk:w-28 desk:h-28 sm:w-32 sm:h-32 md:w-36 md:h-36 row:h-40 row:w-40 lg:h-44 lg:w-44"
              alt="assured"
            />
          </div>
          <div className="relative">
